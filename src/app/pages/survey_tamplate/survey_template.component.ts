...
@Component({
  selector: 'template-survey',
  templateUrl: 'survey_template.component.html',
   styleUrls: ['survey_template.component.css']
})
export class SurveyTemplateComponent implements OnInit {
  ...
  constructor(private service: SurveyService, private router: Router, private route: ActivatedRoute, private auth: AuthenticationService) {
    this.tempSurvey = 0;
  ...
  getTemplate() {
    this.service.getSurveysTemplate(this.buildRequestParams())
      .toPromise()
      .then(e => {
